...
import { homeImage, homeImage2, aboutImage, aboutImage2 } from "@/utils";
...
export default function Home() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Set initial states
      gsap.set([titleRef.current, subtitleRef.current, buttonRef.current, indicatorsRef.current], {
        opacity: 0,
        y: 30
      });
    ...
    <div className="h-screen flex flex-col relative overflow-x-hidden">
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 px-4">
          <h1 
            ref={titleRef}
            className="text-4xl md:text-6xl lg:text-7xl max-w-3xl font-bold text-center mb-6 tracking-wider leading-tight"
          >
            Blaq Samurai
          </h1>
          <p 
