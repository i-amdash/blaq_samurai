      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-20 text-center text-white max-w-4xl px-4">
            ...
            <h1 ref={titleRef} className="text-5xl md:text-7xl font-bold mb-6 tracking-wider">
              BLAQ SAMURAI
            </h1>
            <p ref={subtitleRef} className="text-xl md:text-2xl font-light max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div ref={storyRef} className="space-y-8">
                ...
                <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                  <p>
                    Born from the fusion of ancient samurai philosophy and modern streetwear culture, 
                    Blaq Samurai represents more than just clothing — its a way of life.
                  </p>
                  <p>
                    Every piece we create embodies the discipline, honor, and artistic excellence 
                    that defined the legendary warriors of feudal Japan, reimagined for the 
                    contemporary world.
                  </p>
                  <p>
                    Our commitment to quality, attention to detail, and respect for craftsmanship 
                    ensures that each garment tells a story of heritage and innovation.
                  </p>
                </div>
              </div>
              <div ref={storyImageRef} className="relative h-[500px] rounded-lg overflow-hidden shadow-2xl">
                <Image
                  src={aboutImage2}
                  alt="Brand Story"
                  fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div ref={valuesRef} className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                The principles that guide every decision, every design, and every stitch
              </p>
            </div>

            <div ref={valueCardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {/* Honor */}
              <div className="text-center group">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Integrity in every aspect of our business, from sourcing materials 
                  to customer service.
                </p>
              </div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div ref={craftsmanshipImageRef} className="relative h-[600px] rounded-lg overflow-hidden shadow-2xl">
                <Image
                  src={aboutImage3}
                  alt="Craftsmanship"
                  fill
              ...
              <div ref={craftsmanshipRef} className="space-y-8">
                ...
                <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                  <p>
                    Each Blaq Samurai piece is meticulously crafted by skilled artisans 
                    who understand that true quality cannot be rushed.
                  </p>
                  <p>
                    From the initial design concept to the final stitch, we employ 
                    traditional techniques enhanced by modern innovation to create 
                    garments that are both beautiful and durable.
                  </p>
                  <p>
        ...
        <section className="py-20 bg-primary text-white">
          <div ref={ctaRef} className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Join the Brotherhood
            </h2>
            <p className="text-xl mb-12 leading-relaxed">
              Become part of a community that values quality, honor, and authentic style.
            </p>
